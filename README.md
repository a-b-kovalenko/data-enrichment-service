...
`outbox_event`. Publisher вихідних подій буде реалізований у наступній фазі.
...
- RabbitMQ для input, retry, DLQ та запланованої output topology.
...
Завершено фази 1–6: фундамент, контракти, persistence, HTTP client із Circuit
Breaker, idempotent application flow та RabbitMQ listener із retry/DLQ.
Наступна фаза — transactional outbox publisher.
